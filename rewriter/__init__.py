...
1. **Routing** (:mod:`rewriter.routing`): a probe router over frozen
   Qwen3-4B activations (vendored at :mod:`rewriter.routing_probe`, weights
   and training code included) produces a REFUSE/REWRITE decision and a
   content domain per prompt. Deterministic, one forward pass, no API call.
